...
import proyectogestioneventos.utils.DatosIniciales;
...
public class GestionRecintosViewController {
    ...
    void onAdministrarZonasClick(ActionEvent event) {
        ...
        if (recintoSeleccionado != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/proyectogestioneventos/usuario/administrador/GestionZonasView.fxml"));
